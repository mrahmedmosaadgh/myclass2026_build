import{r as u}from"./questionParser-NE2Nbhvd.js";import{ag as T,I as E,L as O,ac as n,ad as i,U as v,ak as b,ae as o,ai as m,aj as p,aC as j,ah as D}from"./feature-classroom-records-BVzcKgo-.js";import"./purify.es-BgtpMKW3.js";import"./katex-Ba0TdBF8.js";import"./feature-Gamification-B6v894k_.js";import"./feature-Communication-CmyvtPLQ.js";import"./vendor-firebase-CYOMVQO5.js";import"./vendor-draggable-CRx0L8jK.js";const N={key:0,class:"text-center text-gray-500 py-8"},P={key:1,class:"space-y-8"},L={class:"flex justify-between items-start mb-4"},H={class:"font-semibold text-lg text-gray-800 flex items-center"},M={class:"bg-indigo-600 text-white rounded-full w-8 h-8 flex items-center justify-center mr-3"},R={key:0},z=["onClick"],B=["innerHTML"],F={class:"p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors"},I={class:"flex items-start gap-3"},V={class:"option-marker font-medium text-gray-600 flex-shrink-0"},W=["innerHTML"],q={key:1,class:"mt-4 bg-green-50 p-4 rounded-lg border border-green-200"},Q={class:"text-green-700"},J={key:2,class:"mt-4 text-sm text-gray-600 flex items-center"},K={class:"ml-2 bg-gray-100 px-2 py-1 rounded"},U={key:3,class:"mt-4 bg-blue-50 p-4 rounded-lg border border-blue-100"},X=["innerHTML"],Y={__name:"TestWorksheetDisplay",props:{questions:{type:Array,required:!0,default:()=>[]},settings:{type:Object,required:!0,default:()=>({showOptions:!0,show_title:!0,showCorrectAnswers:!1,showExplanations:!1,showScore:!0,layout:"compact",showStepNumbers:!0,showNotes:!0,optionsPerRow:"1"})}},emits:["questionDeleted"],setup(a,{expose:x,emit:k}){const l=a,C=k;E(()=>l.settings,e=>{console.log("Settings changed:",e),console.log("Options per row:",e.optionsPerRow)},{deep:!0}),O(()=>{console.log("Initial settings:",l.settings),console.log("Options per row:",l.settings.optionsPerRow)});const _=()=>l.questions.map((e,s)=>`
    ...
    `;e.document.write(s),e.document.close(),setTimeout(()=>{e.print(),e.onafterprint=()=>{e.close()}},500)},g=e=>Array.isArray(e)?e.map(s=>({...s,option:u(s.option),feedback:s.feedback?u(s.feedback):""})):[],h=e=>{if(!e)return"";try{const s=typeof e=="string"?JSON.parse(e):e;return Array.isArray(s)?s.map((t,c)=>{let d="";return t.step&&(d+=`<div class="explanation-step">
        ...
        `,d.prepend(r),s||d.querySelectorAll(".correct-answer").forEach(A=>A.style.display="none"),console.log("not working html2pdf___....."),!0}catch(t){throw console.error("PDF generation failed:",t),t}},print:$});const f=e=>e?u(e):"",S=(e,s)=>{if(confirm("Are you sure you want to delete this question?"))try{C("questionDeleted",{question:e,index:s})}catch(t){console.error("Error deleting question:",t),alert("Failed to delete question")}};return(e,s)=>(n(),i("div",{class:D(["p-6",a.settings.layout])},[!a.questions||a.questions.length===0?(n(),i("div",N," No questions available ")):(n(),i("div",P,[(n(!0),i(v,null,b(a.questions,(t,c)=>(n(),i("div",{key:c,class:"question-item bg-white rounded-lg shadow-sm border border-gray-200 p-6"},[o("div",L,[o("div",H,[o("span",M,m(c+1),1),a.settings.show_title?(n(),i("span",R,m(t.title||"Question"),1)):p("",!0)]),o("button",{onClick:d=>S(t,c),class:"text-red-600 hover:text-red-800 transition-colors",title:"Delete question"},[...s[0]||(s[0]=[o("svg",{xmlns:"http://www.w3.org/2000/svg",class:"h-5 w-5",viewBox:"0 0 20 20",fill:"currentColor"},[o("path",{"fill-rule":"evenodd",d:"M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z","clip-rule":"evenodd"})],-1)])],8,z)]),o("div",{class:"mb-6 text-gray-700 question-content",innerHTML:f(t.body)},null,8,B),a.settings.showOptions&&t.options?(n(),i("div",{key:0,class:"options-container",style:j({display:"grid",gridTemplateColumns:`repeat(${Number(a.settings.optionsPerRow)||1}, minmax(0, 1fr))`,gap:"0.75rem",width:"100%"})},[(n(!0),i(v,null,b(g(t.options),(d,r)=>(n(),i("div",{key:r,class:"option-item",style:{minWidth:"0",breakInside:"avoid"}},[o("div",F,[o("div",I,[o("span",V,m(String.fromCharCode(65+r))+". ",1),o("div",{class:"flex-grow",innerHTML:d.option},null,8,W)])])]))),128))],4)):p("",!0),a.settings.showCorrectAnswers&&t.options?(n(),i("div",q,[s[1]||(s[1]=o("div",{class:"font-medium text-green-800 mb-2"},"The Correct Answer:",-1)),o("div",Q,m(y(t.options)),1)])):p("",!0),a.settings.showScore&&t.score?(n(),i("div",J,[s[2]||(s[2]=o("span",{class:"font-medium"},"Score:",-1)),o("span",K,m(t.score),1)])):p("",!0),a.settings.showExplanations&&t.explanation?(n(),i("div",U,[s[3]||(s[3]=o("div",{class:"font-medium text-blue-800 mb-2"},"Explanation:",-1)),o("div",{class:"text-blue-700",innerHTML:h(t.explanation)},null,8,X)])):p("",!0)]))),128))]))],2))}},ae=T(Y,[["__scopeId","data-v-edcc35a5"]]);export{ae as default};
