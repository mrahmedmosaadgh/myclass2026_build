import{b as qe,a0 as Ge,g as Q,c as D,ak as Z,d as Le,ae as P,a2 as N,f as x,a1 as ee,o as Ue,e as De}from"./app-CndZJgSn.js";import{Q as Ve}from"./QBtnToggle-uw3Wl9Pz.js";import ke from"./TextToSpeechButton-D5CrmQqe.js";import{e as M,w as J,o as $e,ae as Fe,V as y,W as K,X as b,B as d,a1 as _,a6 as q,Z as V,a4 as O,i as He}from"./vendor-draggable-tEf0qgFD.js";import"./vendor-firebase-CYOMVQO5.js";var te;(function(e){e.STRING="string",e.NUMBER="number",e.INTEGER="integer",e.BOOLEAN="boolean",e.ARRAY="array",e.OBJECT="object"})(te||(te={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vt(e,t,n,o){return(await H(t,G.EMBED_CONTENT,e,!1,JSON.stringify(n),o)).json()}async function pt(e,t,n,o){const s=n.requests.map(a=>Object.assign(Object.assign({},a),{model:t}));return(await H(t,G.BATCH_EMBED_CONTENTS,e,!1,JSON.stringify({requests:s}),o)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
