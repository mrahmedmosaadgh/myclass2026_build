import c from"./purify.es-BgtpMKW3.js";import B from"./EditorToolbar-B1fcXMqK.js";import D from"./EditorContent-DU0G0zWB.js";import E from"./PrintLayout-lv8l_2JS.js";import{b as F}from"./app-BCzNx8e0.js";import{e as i,w as M,V as R,Z as H,B as p,i as b}from"./vendor-draggable-tEf0qgFD.js";import"./TitleInput-CfeVFsua.js";import"./TextFormatControls-DBsz-ZJ8.js";import"./createLucideIcon-Bry4BaGt.js";import"./LineSpacingControl-DgVEaiX_.js";import"./AlignmentControls--dkvSLSr.js";import"./ImageControls-DF85AKdX.js";import"./image-BxEeYmT1.js";import"./PrintButton-KfgAHaMi.js";import"./printer-1I6S-1FG.js";import"./vendor-firebase-BCO40ktT.js";/* empty css            */const L={class:"relative bg-white"},N={__name:"ReusableHtmlViewer",props:{modelValue:{type:String,required:!0},title:{type:String,default:"Document"}},emits:["update:modelValue"],setup(g,{emit:h}){const s=g,v=h,m=i(s.title),C=i(null),o=i(null),l=i(1.5),r=i("left"),f=i("inline-block"),d=i(100),u=i([]),V=[5,10,15,20,25,33,50,75,100,110,120,150,200,300],y=b(()=>c.sanitize(s.modelValue)),z=b(()=>["bold","italic","underline"].filter(e=>document.queryCommandState(e))),k=e=>{const t=e.target.innerHTML,n=c.sanitize(t);v("update:modelValue",n)},I=e=>{document.execCommand(e,!1,null)},$=e=>{e.target.tagName==="IMG"&&(u.value=[e.target])},U=()=>{u.value.length&&u.value.forEach(e=>{e.style.width=`${d.value}%`})},_=()=>{const e=window.open("","_blank"),t=`
        <!DOCTYPE html>
        <html>
        <head>
            <title>${m.value}</title>
