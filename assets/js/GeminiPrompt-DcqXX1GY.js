import{a as Q,d as D,ax as qe,ao as P,l as N,b as x,n as Z,Q as Ge}from"./feature-Communication-CmyvtPLQ.js";import{k as ee,m as Le,b as Ue}from"./feature-Gamification-B6v894k_.js";import{ag as De,at as Ve,J as M,I as J,L as ke,ab as $e,ac as y,ao as K,ap as b,Q as d,ae as _,aq as q,ad as V,aj as O,O as Fe}from"./feature-classroom-records-BVzcKgo-.js";import je from"./TextToSpeechButton-CrgOZj2w.js";import"./vendor-firebase-CYOMVQO5.js";import"./vendor-draggable-CRx0L8jK.js";var te;(function(e){e.STRING="string",e.NUMBER="number",e.INTEGER="integer",e.BOOLEAN="boolean",e.ARRAY="array",e.OBJECT="object"})(te||(te={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pt(e,t,n,o){return(await j(t,G.EMBED_CONTENT,e,!1,JSON.stringify(n),o)).json()}async function vt(e,t,n,o){const s=n.requests.map(a=>Object.assign(Object.assign({},a),{model:t}));return(await j(t,G.BATCH_EMBED_CONTENTS,e,!1,JSON.stringify({requests:s}),o)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
