import{e as r,w as k,V as q,Z as _,B as l,X as g,a6 as v,a1 as s,I as $,a9 as R,ad as V,_ as f,W as z,a4 as B}from"./vendor-draggable-tEf0qgFD.js";import{ao as i}from"./app-p6y-WM5v.js";import L from"./Modal_99-BWj7tWhP.js";import O from"./TestWorksheetSettings-CGZDubVJ.js";import j from"./TestWorksheetDisplay-COfZ83Nt.js";import{_ as h}from"./LucideIcon-DopH-UVf.js";import{_ as I}from"./PrimaryButton-d-7jrldW.js";import{r as C}from"./questionParser-DtCpsKcV.js";import"./vendor-firebase-BCO40ktT.js";/* empty css            */import"./createLucideIcon-Bry4BaGt.js";import"./printer-1I6S-1FG.js";import"./image-BxEeYmT1.js";import"./purify.es-BgtpMKW3.js";import"./katex-I_dbjnZU.js";const M={class:"flex items-center justify-between"},U={class:"flex items-center space-x-2"},Y={class:"p-0"},G={class:"min-h-[60vh] p-6"},K={class:"hidden"},X={key:1,class:"text-center text-gray-500 py-8"},H={class:"flex items-center justify-between w-full px-6 py-4 bg-gray-50"},Z={class:"flex items-center space-x-2"},J={class:"inline-flex items-center"},ve={__name:"test",props:{questions:{type:Array,required:!0,validator:y=>Array.isArray(y)}},emits:["generate","close","update:questions"],setup(y,{emit:P}){const n=y,T=r(!1),w=r(!1),a=r({showOptions:!0,showCorrectAnswers:!1,showExplanations:!1,showScore:!0,layout:"compact",showStepNumbers:!0,showNotes:!0,optionsPerRow:"2"}),c=r(null),d=r("A4"),p=r(!1),u=r([...n.questions]),D=()=>{u.value=[...n.questions].map(t=>({value:t,sort:Math.random()})).sort((t,e)=>t.sort-e.sort).map(({value:t})=>t),c.value&&c.value.$forceUpdate(),i.success("Questions randomized successfully")},S=P,F=t=>{console.log("Received settings:",t),a.value=t},x=()=>{w.value=!1},E=t=>t.map((e,o)=>`
