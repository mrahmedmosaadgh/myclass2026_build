import{b as ae,a0 as re,e as O,Q as de,c as S,f as a,a2 as V,g as L,p as F,a1 as ce,aq as ue,as as pe,d as me}from"./app-p6y-WM5v.js";import{Q as fe,a as $}from"./QStepper-whmYVgaq.js";import{V as d,W as B,X as i,B as o,a1 as e,Z as u,F as C,$ as I,J as ve,_ as f,a6 as R,I as ge,a4 as J,e as g,i as be}from"./vendor-draggable-tEf0qgFD.js";function xe(p){const{lessonTitle:l,subject:c,grade:r,sections:v,customInstructions:b}=p,w=v.map(x=>`- ${x.title} (${x.id})`).join(`
