import{b as be,aW as ye,a0 as fe,ae as K,i as ge,j as we,k as ve,e as F,H as xe,c as G,d as ke,ak as _e,f as ee,a1 as te,at as $e,al as ae}from"./app-BYaa3y8D.js";import{Q as q}from"./QTd-CQorfa5m.js";import{Q as Pe}from"./QTable-D0zlxDk0.js";import{w as se,o as je,V as u,Z as m,B as i,X as d,a1 as c,J as y,a6 as L,_ as b,W as De,F as le,$ as oe,a2 as ne,a8 as Ne,e as _,i as V}from"./vendor-draggable-tEf0qgFD.js";import{u as Ce}from"./useWeeklyPlansStore-BleVSLco.js";import"./vendor-firebase-CYOMVQO5.js";import"./QMarkupTable-DES4NnyG.js";import"./QLinearProgress-CdfLu0lQ.js";import"./use-fullscreen-Bq6vDFHs.js";import"./schoolData-CHMSa8-a.js";const Se={class:"q-pa-md"},ze={class:"row q-gutter-md items-end"},Te={class:"col-12 col-sm-6"},Qe={class:"col-12 col-sm-4"},Ie={key:0,class:"row justify-center q-pa-xl"},qe={class:"text-h6 text-grey-7 q-mt-md"},Ve={class:"text-grey-6"},Ee={key:2,class:"classrooms-grid"},Le={class:"classroom-header bg-primary text-white q-pa-md"},Be={class:"q-ma-none flex items-center q-gutter-sm"},We={class:"plans-by-day"},He={class:"day-header-row"},Me={class:"day-info"},Ae={class:"day-name"},Fe={class:"day-meta"},Oe={class:"subject-teacher"},Ue={class:"teacher-name"},Ye=["innerHTML"],Je={key:1,class:"text-grey-5"},Re=["innerHTML"],Xe={key:1,class:"text-grey-5"},Ze=["innerHTML"],Ke={key:1,class:"text-grey-5"},Ge={__name:"WeeklyPlanClassroomView",setup(et){const{t:l,locale:B}=ye(),p=Ce(),P=fe(),$=_([]),g=_([]),E=_([]),W=_([]),H=_(!1),M=_(!1),ie=_({rowsPerPage:0}),re=V(()=>[{label:l("weeklyPlans.shortDays.1"),value:1},{label:l("weeklyPlans.shortDays.2"),value:2},{label:l("weeklyPlans.shortDays.3"),value:3},{label:l("weeklyPlans.shortDays.4"),value:4},{label:l("weeklyPlans.shortDays.5"),value:5}]),de=V(()=>[{name:"period",label:l("weeklyPlans.period"),field:"schedule.period_number",align:"center"},{name:"subject",label:l("weeklyPlans.subject"),field:"schedule.cst.subject_name",align:"left"},{name:"cw",label:l("weeklyPlans.classwork"),field:"cw",align:"left"},{name:"hw",label:l("weeklyPlans.homework"),field:"hw",align:"left"},{name:"notes",label:l("weeklyPlans.notes"),field:"notes",align:"left"}]),O=V(()=>$.value.length>0&&g.value.length===$.value.length),ce=V(()=>{var o;let s=W.value;return(o=E.value)!=null&&o.length&&(s=s.filter(e=>{var t;return E.value.includes((t=e.schedule)==null?void 0:t.day)})),s}),U=V(()=>{const s={};return ce.value.forEach(o=>{const e=o.classroom_id;if(!s[e]){const t=$.value.find(a=>a.id===e);s[e]={id:e,name:(t==null?void 0:t.name)||"Unknown",plans:[]}}s[e].plans.push(o)}),Object.values(s).forEach(o=>{o.plans.sort((e,t)=>{var r,n,w,f;const a=(((r=e.schedule)==null?void 0:r.day)||0)-(((n=t.schedule)==null?void 0:n.day)||0);return a!==0?a:(((w=e.schedule)==null?void 0:w.period_number)||0)-(((f=t.schedule)==null?void 0:f.period_number)||0)})}),Object.values(s).sort((o,e)=>o.name.localeCompare(e.name))}),pe=()=>{O.value?g.value=[]:g.value=$.value.map(s=>s.id)},Y=s=>{const o=new Date().getFullYear();let e=new Date(o,0,1),t=e.getDay()===0?0:7-e.getDay(),a=new Date(o,0,1+t);const r=new Date(a);r.setDate(a.getDate()+(p.weekNumber-1)*7);const n=new Date(r);return n.setDate(r.getDate()+(s-1)),n.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},A=s=>{const o={};return s.forEach(e=>{var a;const t=(a=e.schedule)==null?void 0:a.day;o[t]||(o[t]={dayNumber:t,dayName:l(`weeklyPlans.shortDays.${t}`)||`Day ${t}`,plans:[]}),o[t].plans.push(e)}),Object.values(o).forEach(e=>{e.plans.sort((t,a)=>{var r,n;return((r=t.schedule)==null?void 0:r.period_number)-((n=a.schedule)==null?void 0:n.period_number)})}),Object.values(o).sort((e,t)=>e.dayNumber-t.dayNumber)},J=async()=>{if(p.selectedSchoolId){M.value=!0;try{const s=await ae.get(`/api/classrooms?school_id=${p.selectedSchoolId}`);$.value=s.data.data||s.data||[]}catch(s){console.error("Error fetching classrooms:",s)}finally{M.value=!1}}},ue=async()=>{if(!g.value.length){W.value=[];return}H.value=!0;try{const s=g.value.map(e=>ae.get("/weekly-system/api/weekly-plans",{params:{classroom_id:e,week_number:p.weekNumber,semester_number:p.semesterNumber,academic_year_id:p.selectedAcademicYearId}}).then(t=>({classroom_id:e,plans:t.data.data||t.data||[]}))),o=await Promise.all(s);W.value=o.flatMap(e=>e.plans.map(t=>({...t,classroom_id:e.classroom_id})))}catch(s){console.error("Error fetching plans:",s),P.notify({type:"negative",message:"Failed to load weekly plans"})}finally{H.value=!1}},me=s=>{if(!s||!s.plans||!s.plans.length){P.notify({type:"warning",message:"No plans to print for this classroom"});return}const o=A(s.plans),e=`
