import{p as e,u as t,e as n,C as s,d as o,g as a,Q as i,q as l,a as r,n as c}from"./app-BzjXrVp9.js";import{Q as u}from"./QSpace-qzKo_-If.js";import{Q as d}from"./QBtnToggle-CLBD-K6a.js";import{Q as m}from"./QSelect-CciNNEfD.js";import h from"./TextToSpeechButton-CMFTcyNS.js";import{f,a as p,k as g,o as v,ac as E,H as C,I as y,J as b,b as O,O as _,M as w,V as I,L as T}from"./vendor-EI0FRBVb.js";import"./offline-BzIlwqNM.js";import"./i18n-BbKXhR_S.js";import"./ui-B__oX9pK.js";import"./rtl-Cr6c3OOr.js";var A,R,N,S,x,q;(R=A||(A={})).STRING="string",R.NUMBER="number",R.INTEGER="integer",R.BOOLEAN="boolean",R.ARRAY="array",R.OBJECT="object",(S=N||(N={})).LANGUAGE_UNSPECIFIED="language_unspecified",S.PYTHON="python",(q=x||(x={})).OUTCOME_UNSPECIFIED="outcome_unspecified",q.OUTCOME_OK="outcome_ok",q.OUTCOME_FAILED="outcome_failed",q.OUTCOME_DEADLINE_EXCEEDED="outcome_deadline_exceeded";
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Se{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new W("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new Ne(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,n){if(!e.name)throw new Z("Cached content must contain a `name` field.");if(!e.model)throw new Z("Cached content must contain a `model` field.");const s=["model","systemInstruction"];for(const a of s)if((null==t?void 0:t[a])&&e[a]&&(null==t?void 0:t[a])!==e[a]){if("model"===a){if((t.model.startsWith("models/")?t.model.replace("models/",""):t.model)===(e.model.startsWith("models/")?e.model.replace("models/",""):e.model))continue}throw new Z(`Different value for "${a}" specified in modelParams (${t[a]}) and cachedContent (${e[a]})`)}const o=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new Ne(this.apiKey,o,n)}}const xe={class:"row items-center q-gutter-sm"},qe={class:"row q-gutter-md q-mb-md"},Me={key:0,class:"q-mb-md"},Le={class:"text-subtitle2 q-mb-sm"},Ue={class:"row q-gutter-md q-mb-md"},De={class:"row q-gutter-md q-mb-md"},Ge={key:1,class:"q-mb-md"},Pe={class:"text-subtitle2 q-mb-sm"},je={class:"row q-gutter-md q-mb-md"},ke={key:2,class:"q-mb-md"},Fe={class:"text-subtitle2 q-mb-sm"},He={class:"row q-gutter-sm"},Ve={class:"row items-center q-mb-sm"},$e={class:"text-subtitle2"},Be={class:"ai-result"},Ye={key:0,class:"row q-gutter-sm q-mt-md"},Ke={key:1,class:"row q-gutter-sm q-mt-md"},Qe=e({__name:"GeminiPrompt",props:{modelValue:String,extra:String,autoRun:Boolean,questionId:{type:[String,Number],default:null}},emits:["update:modelValue","update:extra","response","use-as-question","use-as-answer"],setup(e,{emit:A}){const R=e,N=A,S=t(),x=f("questions"),q=f(R.modelValue||""),M=f(R.extra||""),L=f(""),U=f(!1),D=f({type:"behavioral",difficulty:"intermediate",topic:"",count:3}),G=f({question:"",style:"professional",length:"detailed"}),P=p(()=>"questions"===x.value?D.value.topic.trim().length>0:"answers"===x.value?G.value.question.trim().length>0:q.value.trim().length>0),j=[{label:"Behavioral",value:"behavioral"},{label:"Technical",value:"technical"},{label:"Situational",value:"situational"},{label:"Knowledge-based",value:"knowledge"},{label:"Problem-solving",value:"problem-solving"}],k=[{label:"Beginner",value:"beginner"},{label:"Intermediate",value:"intermediate"},{label:"Advanced",value:"advanced"},{label:"Expert",value:"expert"}],F=[{label:"Professional",value:"professional"},{label:"Conversational",value:"conversational"},{label:"Technical",value:"technical"},{label:"Educational",value:"educational"},{label:"Creative",value:"creative"}],H=[{label:"Brief",value:"brief"},{label:"Detailed",value:"detailed"},{label:"Comprehensive",value:"comprehensive"}];g(()=>R.modelValue,e=>q.value=e),g(()=>R.extra,e=>M.value=e);const V=new Se(void 0),$=()=>{switch(x.value){case"questions":return"Generate Questions";case"answers":return"Generate Answer";default:return"Ask Gemini"}},B=async()=>{var e,t,n;const s=(()=>{let e="";if("questions"===x.value){const{type:t,difficulty:n,topic:s,count:o}=D.value;e=`Generate ${o} ${n} level ${t} interview questions about ${s}.`,M.value&&(e+=` Additional requirements: ${M.value}`),e+=" Format the response as a numbered list with clear, well-structured questions. Make them practical and relevant for job interviews."}else if("answers"===x.value){const{question:t,style:n,length:s}=G.value;e=`Provide a ${s} ${n} answer to this question: "${t}"`,M.value&&(e+=` Additional context: ${M.value}`),e+=" Make the answer well-structured, informative, and suitable for a job interview context."}else e=[q.value,M.value].filter(Boolean).join("\n\n");return e})();U.value=!0,L.value="";try{const a=V.getGenerativeModel({model:"gemini-1.5-flash"}),i=await a.generateContent(s);console.log("Full Gemini result:",i);let l="No response.";if(null==i?void 0:i.response){console.log("Response object:",i.response);try{l=i.response.text(),console.log("Text extracted via .text():",l)}catch(o){console.log("Error calling .text(), trying manual extraction:",o);const s=i.response.candidates;if(console.log("Candidates:",s),s&&s.length>0){const o=null==(t=null==(e=s[0])?void 0:e.content)?void 0:t.parts;console.log("Parts:",o),o&&o.length>0&&(l=(null==(n=o[0])?void 0:n.text)||"No response.",console.log("Text extracted manually:",l))}}}console.log("Final AI Response:",l),L.value=l,N("response",l),S.notify({type:"positive",message:"AI content generated successfully!",position:"top",icon:"auto_awesome"})}catch(a){console.error("Gemini Error:",a),console.error("Full error details:",a),S.notify({type:"negative",message:"Failed to get a response from Gemini. Check console for details."})}U.value=!1},Y=()=>{navigator.clipboard.writeText(L.value).then(()=>{S.notify({type:"positive",message:"Content copied to clipboard!",position:"top"})})},K=()=>{L.value=""},Q=()=>{N("use-as-question",L.value),S.notify({type:"info",message:"Question content ready to use",position:"top"})},J=()=>{N("use-as-answer",L.value),S.notify({type:"info",message:"Answer content ready to use",position:"top"})},W=()=>{S.notify({type:"info",message:"Edit functionality - copy the content and paste it in your form",position:"top"})};return g(x,()=>{L.value=""}),v(()=>{R.autoRun&&q.value&&B()}),(e,t)=>{const f=E("q-markdown");return y(),C(c,{class:"gemini-prompt-card"},{default:b(()=>[O(o,{class:"bg-gradient-ai text-white"},{default:b(()=>[w("div",xe,[O(n,{name:"auto_awesome",size:"md"}),t[17]||(t[17]=w("div",{class:"text-h6"},"AI Assistant",-1)),O(u),O(s,{icon:"psychology",color:"white","text-color":"primary",size:"sm"},{default:b(()=>t[16]||(t[16]=[I(" Powered by Gemini ")])),_:1})])]),_:1}),O(o,null,{default:b(()=>[w("div",qe,[O(d,{modelValue:x.value,"onUpdate:modelValue":t[0]||(t[0]=e=>x.value=e),"toggle-color":"primary",options:[{label:"Generate Questions",value:"questions",icon:"quiz"},{label:"Generate Answers",value:"answers",icon:"forum"},{label:"Custom Prompt",value:"custom",icon:"edit"}],class:"full-width"},null,8,["modelValue"])]),"questions"===x.value?(y(),T("div",Me,[w("div",Le,[O(n,{name:"quiz",class:"q-mr-xs"}),t[18]||(t[18]=I(" Question Generation Settings "))]),w("div",Ue,[O(m,{modelValue:D.value.type,"onUpdate:modelValue":t[1]||(t[1]=e=>D.value.type=e),options:j,label:"Question Type",class:"col",outlined:"",dense:""},null,8,["modelValue"]),O(m,{modelValue:D.value.difficulty,"onUpdate:modelValue":t[2]||(t[2]=e=>D.value.difficulty=e),options:k,label:"Difficulty Level",class:"col",outlined:"",dense:""},null,8,["modelValue"])]),w("div",De,[O(a,{modelValue:D.value.topic,"onUpdate:modelValue":t[3]||(t[3]=e=>D.value.topic=e),label:"Topic/Subject",placeholder:"e.g., JavaScript, Project Management, Leadership",class:"col",outlined:"",dense:""},null,8,["modelValue"]),O(a,{modelValue:D.value.count,"onUpdate:modelValue":t[4]||(t[4]=e=>D.value.count=e),label:"Number of Questions",type:"number",min:"1",max:"10",class:"col-3",outlined:"",dense:""},null,8,["modelValue"])]),O(a,{modelValue:M.value,"onUpdate:modelValue":[t[5]||(t[5]=e=>M.value=e),t[6]||(t[6]=e=>N("update:extra",e))],label:"Additional Instructions (Optional)",placeholder:"e.g., Focus on practical scenarios, Include code examples",type:"textarea",rows:"2",outlined:"",class:"q-mb-md"},null,8,["modelValue"])])):_("",!0),"answers"===x.value?(y(),T("div",Ge,[w("div",Pe,[O(n,{name:"forum",class:"q-mr-xs"}),t[19]||(t[19]=I(" Answer Generation Settings "))]),O(a,{modelValue:G.value.question,"onUpdate:modelValue":t[7]||(t[7]=e=>G.value.question=e),label:"Question to Answer",placeholder:"Enter the question you want to generate an answer for",type:"textarea",rows:"2",outlined:"",class:"q-mb-md",rules:[e=>!!e||"Question is required for answer generation"]},null,8,["modelValue","rules"]),w("div",je,[O(m,{modelValue:G.value.style,"onUpdate:modelValue":t[8]||(t[8]=e=>G.value.style=e),options:F,label:"Answer Style",class:"col",outlined:"",dense:""},null,8,["modelValue"]),O(m,{modelValue:G.value.length,"onUpdate:modelValue":t[9]||(t[9]=e=>G.value.length=e),options:H,label:"Answer Length",class:"col",outlined:"",dense:""},null,8,["modelValue"])]),O(a,{modelValue:M.value,"onUpdate:modelValue":[t[10]||(t[10]=e=>M.value=e),t[11]||(t[11]=e=>N("update:extra",e))],label:"Additional Context (Optional)",placeholder:"e.g., Target audience, specific requirements, examples to include",type:"textarea",rows:"2",outlined:"",class:"q-mb-md"},null,8,["modelValue"])])):_("",!0),"custom"===x.value?(y(),T("div",ke,[w("div",Fe,[O(n,{name:"edit",class:"q-mr-xs"}),t[20]||(t[20]=I(" Custom Prompt "))]),O(a,{modelValue:q.value,"onUpdate:modelValue":[t[12]||(t[12]=e=>q.value=e),t[13]||(t[13]=e=>N("update:modelValue",e))],label:"Your Prompt",outlined:"",dense:"",autogrow:"",rules:[e=>!!e||"Prompt is required"],class:"q-mb-sm"},null,8,["modelValue","rules"]),O(a,{modelValue:M.value,"onUpdate:modelValue":[t[14]||(t[14]=e=>M.value=e),t[15]||(t[15]=e=>N("update:extra",e))],label:"Extra instructions (optional)",outlined:"",dense:"",autogrow:"",class:"q-mb-md"},null,8,["modelValue"])])):_("",!0),w("div",He,[O(i,{loading:U.value,disable:!P.value,color:"primary",icon:"auto_awesome",label:$(),onClick:B,class:"col"},null,8,["loading","disable","label"]),L.value?(y(),C(i,{key:0,icon:"content_copy",flat:"",color:"primary",onClick:Y},{default:b(()=>[O(l,null,{default:b(()=>t[21]||(t[21]=[I("Copy Result")])),_:1})]),_:1})):_("",!0),L.value?(y(),C(i,{key:1,icon:"clear",flat:"",color:"negative",onClick:K},{default:b(()=>[O(l,null,{default:b(()=>t[22]||(t[22]=[I("Clear Result")])),_:1})]),_:1})):_("",!0)])]),_:1}),L.value?(y(),C(o,{key:0,class:"bg-grey-1"},{default:b(()=>[w("div",Ve,[w("div",$e,[O(n,{name:"auto_awesome",class:"q-mr-xs"}),t[23]||(t[23]=I(" AI Generated Content "))]),O(u),O(h,{text:L.value,size:"sm",round:"",flat:""},null,8,["text"])]),O(r,{class:"q-mb-md"}),w("div",Be,[O(f,{src:L.value},null,8,["src"])]),"questions"===x.value?(y(),T("div",Ye,[O(i,{icon:"add",label:"Use as New Question",color:"positive",flat:"",onClick:Q}),O(i,{icon:"edit",label:"Edit & Use",color:"primary",flat:"",onClick:W})])):_("",!0),"answers"===x.value?(y(),T("div",Ke,[O(i,{icon:"add",label:"Use as Answer",color:"positive",flat:"",onClick:J}),O(i,{icon:"edit",label:"Edit & Use",color:"primary",flat:"",onClick:W})])):_("",!0)]),_:1})):_("",!0)]),_:1})}}},[["__scopeId","data-v-f5e650d1"]]);export{Qe as default};
